          ...
          <div className='flex justify-end'>
            ...
            <div className='flex flex-col gap-3 items-center p-4'>
                ...
                <div className='flex gap-5 flex-between'>
                  ...
                  <button onClick={()=>eliminarProducto(producto.id)} type='button' className='rounded text-center text-white font-semibold uppercase p-2 bg-red-500 hover:bg-red-700 transition-all'>Sí, eliminar</button>
                </div>
