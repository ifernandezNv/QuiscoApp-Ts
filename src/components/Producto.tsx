  ...
  return (
    <div className='border rounded shadow p-4 flex flex-col gap-3'>
        ...
        <div className='p-4'>
            ...
            <button type='submit' onClick={()=> esconderModal()} className='w-full bg-indigo-700 hover:bg-indigo-900 text-center text-white font-bold p-2 mt-5 rounded transition-all'>Añadir al Pedido</button>
        </div>
    </div>
  )
}
